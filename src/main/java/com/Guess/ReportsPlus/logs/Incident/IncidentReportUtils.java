...
public class IncidentReportUtils {
	...
	public static Map<String, Object> incidentLayout() {
		Map<String, Object> incidentReport = createReportWindow(localization.getLocalizedMessage("ReportWindows.IncidentReportTitle", "Incident Report"), null, new SectionConfig(localization.getLocalizedMessage("ReportWindows.OfficerInfoSectionHeading", "Officer Information"), new RowConfig(
		                                                        ...
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.TimeLocationInfoheader", "Timestamp / Location Information"),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"), 3, FieldType.DATE_FIELD),
		                                                                                        ...
		                                                                                        new FieldConfig(localization.getLocalizedMessage("ReportWindows.IncidentNumField", "incident num"), 5, FieldType.NUMBER_FIELD)),
		                                                        ...
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.PartiesInvolvedSectionHeader", "Parties Involved"),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.SuspectsField", "suspect(s)"), 6, FieldType.TEXT_FIELD),
		                                                                                        new FieldConfig(localization.getLocalizedMessage("ReportWindows.VictimsWitnessField", "victim(s) / witness(s)"), 6, FieldType.TEXT_FIELD)),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.StatementField", "statement"), 12, FieldType.TEXT_AREA))),
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.NotesSummarySectionheader", "Notes / Summary"),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.IncidentSummaryField", "summary"), 12, FieldType.TEXT_AREA)),
