...
public class customizationDataLoader {
    ...
    private static final List<String> DEFAULT_AGENCIES = Arrays.asList(
            ...
            "San Andreas State Parks [SASP]",
            "Drug Obeservation Agency [DOA]",
            "Burea of Alcohol, Tobacco, Firearms and Explosives [ATF]",
            "Patriotism and Immigration Authority [PIA]",
            "United States Marshal Service [USMS]"
    );
    private static final List<String> DEFAULT_RANKS = Arrays.asList(
            "POLICE DEPARTMENT",
            "Police Officer",
    ...
    private static final List<String> DEFAULT_DIVISIONS = Arrays.asList(
            "PATROL OPERATIONS",
            "Central Patrol Division",
            "Northern Patrol Division",
            "Southern Patrol Division",
            "Eastern Patrol Division",
            "Western Patrol Division",
            "Harbor/Port Patrol Division",
            "",
            "CRIMINAL INVESTIGATIONS",
            "Major Crimes Division",
            "Homicide & Violent Crimes Section",
            "Narcotics & Gang Enforcement Section",
            "Special Victims Unit",
            "Forensic Science Section",
            "Financial Crimes Section",
            "",
            "SPECIAL OPERATIONS",
            "SWAT/Tactical Division",
            "K-9 Unit",
            ...
            "Correctional Facilities Unit",
            "",
            "REGIONAL COMMANDS",
            "Metro Region Command",
    ...
    private static final List<String> DEFAULT_AREALIST = Arrays.asList(
            "N/A",
            "Alamo Sea",
            "Alta",
            "Backlot City",
    ...
    private static final List<String> DEFAULT_SEARCH_METHODS = Arrays.asList(
            "N/A",
            "Search Warrant",
            "Probable Cause",
            "Consent Search",
    ...
    private static final List<String> DEFAULT_SEARCH_TYPES = Arrays.asList(
            "N/A",
            "Vehicle Search",
            "Personal Search",
            "Premises Search",
    ...
    private static final List<String> DEFAULT_CAR_COLORS = Arrays.asList(
            "N/A",
            "Black",
            "White",
            "Silver",
    ...
    private static final List<String> DEFAULT_VEHICLE_TYPES = Arrays.asList(
            "N/A",
            "Car",
            "Truck",
            "Motorcycle",
