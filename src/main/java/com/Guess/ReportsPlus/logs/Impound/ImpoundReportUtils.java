...
public class ImpoundReportUtils {
	...
	public static Map<String, Object> impoundLayout() {
		...
		SectionConfig offenderInfoSection = new SectionConfig(localization.getLocalizedMessage("ReportWindows.OffenderInfoSectionHeading", "Offender Information"),
		                                                      ...
		                                                      new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldOffenderAddress", "offender address"), 12, FieldType.TEXT_FIELD)));
		offenderInfoSection.setHasButton(true);
		
		Map<String, Object> impoundReport = createReportWindow(localization.getLocalizedMessage("ReportWindows.ImpoundReportTitle", "Impound Report"), null, new SectionConfig(localization.getLocalizedMessage("ReportWindows.OfficerInfoSectionHeading", "Officer Information"), new RowConfig(
		                                                       ...
		                                                       new SectionConfig(localization.getLocalizedMessage("ReportWindows.LocationInfoSectionHeading", "Location / Timestamp Information"),
		                                                                         new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"), 5, FieldType.DATE_FIELD),
		                                                                                       ...
		                                                                                       new FieldConfig(localization.getLocalizedMessage("ReportWindows.ImpoundNumField", "impound number"), 2, FieldType.NUMBER_FIELD))), offenderInfoSection, vehInfoSection,
	...
	public static Map<String, Object> newImpound() {
		...
		Button offenderInfoBtn = (Button) impoundReport.get(localization.getLocalizedMessage("ReportWindows.OffenderInfoSectionHeading", "Offender Information") + "_button");
		
		Button vehInfoBtn = (Button) impoundReport.get(localization.getLocalizedMessage("ReportWindows.OffenderVehicleInfoSectionHeading", "Offender Vehicle Information") + "_button");
