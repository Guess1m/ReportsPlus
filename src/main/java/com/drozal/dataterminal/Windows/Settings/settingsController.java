...
public class settingsController {
    ...
    public static void loadTheme() throws IOException {
        ...
        controllerVar.getOrientationBtn().setOnMouseEntered(e -> controllerVar.getOrientationBtn().setStyle(hoverStyle + ";-fx-text-fill: white;"));
        controllerVar.getOrientationBtn().setOnMouseExited(e -> controllerVar.getOrientationBtn().setStyle(nonTransparentBtn + "-fx-text-fill: white;"));

        controllerVar.getProbabilitySettingsBtn().setStyle(nonTransparentBtn + "-fx-text-fill: white;");
        controllerVar.getProbabilitySettingsBtn().setOnMouseEntered(e -> controllerVar.getProbabilitySettingsBtn().setStyle(hoverStyle + ";-fx-text-fill: white;"));
        controllerVar.getProbabilitySettingsBtn().setOnMouseExited(e -> controllerVar.getProbabilitySettingsBtn().setStyle(nonTransparentBtn + "-fx-text-fill: white;"));
