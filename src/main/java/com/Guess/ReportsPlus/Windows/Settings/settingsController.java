...
public class settingsController {
	...
	private void addLocale() {
		...
		autofillLocationInfoLabel.setText(localization.getLocalizedMessage("Settings.autofillLocationInfoLabel", "AutoFill Location Information"));
		autofillLocationInfoTT.setText(localization.getLocalizedMessage("Settings.autofillLocationInfoTT", "Automatically fill in street, area, county information into reports when connected"));
