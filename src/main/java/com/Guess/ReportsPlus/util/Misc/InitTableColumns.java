...
public class InitTableColumns {
	...
	public static void initializeDeathReportColumns(TableView tableview) {
		...
		ObservableList<TableColumn<DeathReport, ?>> deathReportColumns = FXCollections.observableArrayList(notesColumn, divisionColumn, agencyColumn, numberColumn, rankColumn, nameColumn, streetColumn, countyColumn, areaColumn, dateColumn, timeColumn, deathReportNumberColumn, decedentColumn,
		                                                                                                   ageColumn, genderColumn, descriptionColumn, addressColumn, witnessesColumn, causeOfDeathColumn, modeOfDeathColumn, timeofDeathColumn, dateOfDeathColumn);
	...
	public static void initializeImpoundColumns(TableView tableview) {
		...
		ObservableList<TableColumn<ImpoundReport, ?>> impoundColumns = FXCollections.observableArrayList(impoundNumberColumn, impoundDateColumn, impoundTimeColumn, ownerNameColumn, ownerAgeColumn, ownerGenderColumn, ownerAddressColumn, impoundPlateNumberColumn, impoundModelColumn, impoundTypeColumn,
		                                                                                                 impoundColorColumn, impoundCommentsColumn, officerRankColumn, officerNameColumn, officerNumberColumn, officerDivisionColumn, officerAgencyColumn);
	...
	public static void initializePatrolColumns(TableView tableview) {
		...
		ObservableList<TableColumn<PatrolReport, ?>> patrolColumns = FXCollections.observableArrayList(patrolNumberColumn, patrolDateColumn, patrolLengthColumn, patrolStartTimeColumn, patrolStopTimeColumn, officerRankColumn, officerNameColumn, officerNumberColumn, officerDivisionColumn,
		                                                                                               officerAgencyColumn, officerVehicleColumn, patrolCommentsColumn);
	...
	public static void initializeCitationColumns(TableView tableview) {
		...
		ObservableList<TableColumn<TrafficCitationReport, ?>> citationColumns = FXCollections.observableArrayList(citationNumberColumn, citationDateColumn, citationTimeColumn, citationChargesColumn, citationCountyColumn, citationAreaColumn, citationStreetColumn, offenderNameColumn,
		                                                                                                          offenderGenderColumn, offenderAgeColumn, offenderHomeAddressColumn, offenderDescriptionColumn, offenderVehicleModelColumn, offenderVehicleColorColumn, offenderVehicleTypeColumn,
		                                                                                                          offenderVehiclePlateColumn, offenderVehicleOtherColumn, officerRankColumn, officerNameColumn, officerNumberColumn, officerDivisionColumn, officerAgencyColumn, citationCommentsColumn);
	...
	public static void initializeArrestColumns(TableView tableview) {
		...
		ObservableList<TableColumn<ArrestReport, ?>> arrestColumns = FXCollections.observableArrayList(arrestNumberColumn, arrestDateColumn, arrestTimeColumn, arrestChargesColumn, arrestCountyColumn, arrestAreaColumn, arrestStreetColumn, arresteeNameColumn, arresteeAgeColumn, arresteeGenderColumn,
		                                                                                               arresteeDescriptionColumn, ambulanceYesNoColumn, taserYesNoColumn, arresteeMedicalInformationColumn, arresteeHomeAddressColumn, arrestDetailsColumn, officerRankColumn, officerNameColumn,
	...
	public static void initializeIncidentColumns(TableView tableview) {
		...
		ObservableList<TableColumn<IncidentReport, ?>> incidentColumns = FXCollections.observableArrayList(incidentNumberColumn, incidentDateColumn, incidentTimeColumn, incidentStatementColumn, incidentWitnessesColumn, incidentVictimsColumn, officerNameColumn, officerRankColumn, officerNumberColumn,
		                                                                                                   officerAgencyColumn, officerDivisionColumn, incidentStreetColumn, incidentAreaColumn, incidentCountyColumn, incidentActionsTakenColumn, incidentCommentsColumn);
	...
	public static void initializeSearchColumns(TableView tableview) {
		...
		ObservableList<TableColumn<SearchReport, ?>> searchColumns = FXCollections.observableArrayList(searchNumberColumn, searchDateColumn, searchTimeColumn, searchSeizedItemsColumn, searchGroundsColumn, searchTypeColumn, searchMethodColumn, searchWitnessesColumn, officerRankColumn,
		                                                                                               officerNameColumn, officerNumberColumn, officerAgencyColumn, officerDivisionColumn, searchStreetColumn, searchAreaColumn, searchCountyColumn, searchCommentsColumn, searchedPersonsColumn,
		                                                                                               testsConductedColumn, resultsColumn, BACMeasurementColumn);
	...
	public static void initializeTrafficStopColumns(TableView tableview) {
		...
		ObservableList<TableColumn<TrafficStopReport, ?>> trafficStopColumns = FXCollections.observableArrayList(stopNumberColumn, dateColumn, timeColumn, modelColumn, otherInfoColumn, operatorNameColumn, operatorAgeColumn, operatorAddressColumn, operatorDescriptionColumn, operatorGenderColumn,
		                                                                                                         nameColumn, rankColumn, numberColumn, divisionColumn, agencyColumn, commentsTextAreaColumn, streetColumn, countyColumn, areaColumn, plateNumberColumn, colorColumn, typeColumn);
	...
	public static void initializeCalloutColumns(TableView tableview) {
		...
		ObservableList<TableColumn<CalloutReport, ?>> columns = FXCollections.observableArrayList(calloutNumberColumn, dateColumn, timeColumn, notesTextAreaColumn, responseGradeColumn, responseTypeColumn, divisionColumn, agencyColumn, numberColumn, rankColumn, nameColumn, addressColumn,
	...
	public static void initializeAccidentColumns(TableView tableview) {
		...
		ObservableList<TableColumn<AccidentReport, ?>> columns = FXCollections.observableArrayList(accidentNumberColumn, dateColumn, timeColumn, streetColumn, areaColumn, countyColumn, weatherConditionsColumn, roadConditionsColumn, otherVehiclesInvolvedColumn, plateNumberColumn, colorColumn,
		                                                                                           typeColumn, modelColumn, ownerNameColumn, ownerAgeColumn, ownerGenderColumn, ownerAddressColumn, ownerDescriptionColumn, witnessesColumn, injuriesReportedColumn, damageDetailsColumn, officerRankColumn,
		                                                                                           officerNameColumn, officerNumberColumn, officerAgencyColumn, officerDivisionColumn, commentsColumn);
		tableview.getColumns().addAll(columns);
