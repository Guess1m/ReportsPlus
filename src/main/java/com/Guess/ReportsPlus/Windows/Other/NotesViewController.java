...
public class NotesViewController {
	...
	public void oncodesclick() {
		if (mainDesktopControllerObj != null) {
			codesWindow = WindowManager.createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), "Windows/Misc/codes-window.fxml", "Notepad Codes", false, 1, true, false,
