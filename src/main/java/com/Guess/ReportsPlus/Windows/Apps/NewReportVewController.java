...
public class NewReportVewController {
	...
	public void createReportButton(ActionEvent actionEvent) {
		CustomWindow layoutWindow = WindowManager.createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), "Windows/Other/layout-builder-view.fxml", "Layout Builder", true, 1, true, false, mainDesktopControllerObj.getTaskBarApps(),
