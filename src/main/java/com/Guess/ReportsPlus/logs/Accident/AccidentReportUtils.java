...
public class AccidentReportUtils {
	...
	public static Map<String, Object> accidentLayout() {
		...
		SectionConfig vehInfoSection = new SectionConfig(localization.getLocalizedMessage("ReportWindows.OffenderVehicleInfoSectionHeading", "Offender Vehicle Information"), new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldModel", "model"), 6, FieldType.TEXT_FIELD),
		                                                                                                                                                                                    new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldPlateNumber", "plate number"), 6,
		                                                                                                                                                                                                    FieldType.TEXT_FIELD)),
		                                                 new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldType", "type"), 7, FieldType.COMBO_BOX_TYPE),
		                                                               new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldColor", "color"), 5, FieldType.COMBO_BOX_COLOR)));
		vehInfoSection.setHasButton(true);
		
		Map<String, Object> accidentReport = createReportWindow(localization.getLocalizedMessage("ReportWindows.AccidentReportTitle", "Accident Report"), null, new SectionConfig(localization.getLocalizedMessage("ReportWindows.OfficerInfoSectionHeading", "Officer Information"), new RowConfig(
		                                                        ...
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.LocationInfoSectionHeading", "Location / Timestamp Information"),
		                                                                          ...
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"), 5, FieldType.DATE_FIELD),
		                                                                                        ...
		                                                                                        new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentNumberField", "accident number"), 2, FieldType.NUMBER_FIELD))),
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.AccidentInformationSection", "Accident Information"),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentWeatherConditionsField", "weather conditions"), 6, FieldType.TEXT_FIELD),
		                                                                                        new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentRoadConditionsField", "road conditions"), 6, FieldType.TEXT_FIELD)),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentOtherVehiclesField", "other vehicles involved"), 12, FieldType.TEXT_FIELD)),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldWitnesses", "witnesses"), 12, FieldType.TEXT_FIELD)),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentInjuriesField", "injuries"), 12, FieldType.TEXT_FIELD)),
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.AccidentDamagesField", "damages"), 12, FieldType.TEXT_FIELD))), offenderInfoSection, vehInfoSection,
	...
	public static Map<String, Object> newAccident() {
		...
		Button offenderInfoBtn = (Button) accidentReport.get(localization.getLocalizedMessage("ReportWindows.OffenderInfoSectionHeading", "Offender Information") + "_button");
		
		Button vehInfoBtn = (Button) accidentReport.get(localization.getLocalizedMessage("ReportWindows.OffenderVehicleInfoSectionHeading", "Offender Vehicle Information") + "_button");
