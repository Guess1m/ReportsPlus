...
public class actionController {
    ...
    public void onMouseEnter(MouseEvent mouseEvent) throws IOException {
        if (hasEntered) {
            ...
            createSpinner(getArrestsSpinner(), 0, 9999, 0);
            createSpinner(getSearchesSpinner(), 0, 9999, 0);
            createSpinner(getIncidentSpinner(), 0, 9999, 0);
            createSpinner(getPatrolsSpinner(), 0, 9999, 0);
            createSpinner(trafficStopSpinner, 0, 9999, 0);
