...
public class LayoutBuilderController {
	...
	private void openCustomDropdownWindow() {
		...
		deleteBtn.setOnAction(e -> {
			...
			CustomWindow confirmDialog = createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), layoutPane, "Confirm", true, 1, true, true, mainDesktopControllerObj.getTaskBarApps(),
			                                                new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/report.png"))));
		...
		exportBtn.setOnAction(e -> {
			...
			CustomWindow exportDialog = createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), exportBorderPane, "Export", false, 1, true, true, mainDesktopControllerObj.getTaskBarApps(),
			                                               new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/report.png"))));
		...
		importBtn.setOnAction(e -> {
			...
			try {
				...
				CustomWindow confirmDialog = createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), layoutPane, "Import", false, 1, true, true, mainDesktopControllerObj.getTaskBarApps(),
				                                                new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/report.png"))));
		...
		addDropdownWindow = createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), window, localization.getLocalizedMessage("DropdownCreator.windowTitle", "Dropdown Manager"), true, 1, true, true, mainDesktopControllerObj.getTaskBarApps(),
		                                       new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/report.png"))));
	}
	...
	private class FieldPane extends VBox {
		...
		FieldPane(int defaultWidth) {
			...
			fieldRow.getChildren().addAll(new Label(localization.getLocalizedMessage("Login_Window.NamePromptText", "Name") + ": "), fieldNameField, new Label("Populate Key:"), populateKeyField, new Label(localization.getLocalizedMessage("ReportWindows.WidthLabel", "Width:")), widthSpinner,
			                              new Label(localization.getLocalizedMessage("ReportWindows.TypeLabel", "Type:")), fieldTypeComboBox, buttonBox);
	...
	private class ElementPane extends HBox {
		...
		ElementPane() {
			...
			getChildren().addAll(new Label(localization.getLocalizedMessage("ReportWindows.ElementButton", "Element") + ":"), elementNameField, new Label(localization.getLocalizedMessage("ReportWindows.ReportLabel", "Report") + ":"), reportComboBox, removeElementButton, moveUpButton,
			                     moveDownButton);
		}
