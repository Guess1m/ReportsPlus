...
public class PatrolReportUtils {
	public static Map<String, Object> patrolLayout() {
		...
		Map<String, Object> patrolReport = createReportWindow(
				...
				new SectionConfig(
						localization.getLocalizedMessage("ReportWindows.ShiftInfoheader", "Shift Information"),
						new RowConfig(
								new FieldConfig(
										localization.getLocalizedMessage("ReportWindows.StartTimeField", "starttime"),
										3, FieldType.TEXT_FIELD),
								new FieldConfig(
										localization.getLocalizedMessage("ReportWindows.StopTimeField", "stoptime"), 4,
										FieldType.TIME_FIELD),
								new FieldConfig(localization.getLocalizedMessage("ReportWindows.PatrolNumField",
										"patrolnumber"), 5, FieldType.NUMBER_FIELD)),
						new RowConfig(
								new FieldConfig(localization.getLocalizedMessage("ReportWindows.LengthField", "length"),
										3, FieldType.TEXT_FIELD),
