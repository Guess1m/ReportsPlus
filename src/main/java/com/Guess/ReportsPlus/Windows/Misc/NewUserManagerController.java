...
public class NewUserManagerController {
	...
	public void createUserBtn(ActionEvent actionEvent) {
		...
		addUserWindow = createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), window, "New Profile", false, 1, true, true, mainDesktopControllerObj.getTaskBarApps(),
		                                   new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/Apps/profile.png"))));
	}
