...
public class updatesController {
    ...
    public void LaunchUpdater(ActionEvent actionEvent) {
        if (updateAvailable) {
            CustomWindow updaterToolWindow = WindowManager.createCustomWindow(mainDesktopControllerObj.getDesktopContainer(), "Windows/Misc/autoUpdater-tool.fxml", "AutoUpdate Utility", true, 1, true, true, mainDesktopControllerObj.getTaskBarApps(), new Image(Objects.requireNonNull(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/Logo.png"))));
        }
    }
