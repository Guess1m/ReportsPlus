...
public class TrafficCitationUtils {
	...
	public static Map<String, Object> citationLayout() {
		...
		SectionConfig vehicleInfoSection = new SectionConfig(localization.getLocalizedMessage("ReportWindows.CitationVehicleInfoHeading", "(If Applicable) Offender Vehicle Information"),
		...
		Map<String, Object> citationReport = createReportWindow(localization.getLocalizedMessage("ReportWindows.CitationReportTitle", "Citation Report"),
		                                                        new TransferConfig(localization.getLocalizedMessage("ReportWindows.TransferReportInfoButton", "Transfer Information To New Report"), new RowConfig(new FieldConfig("transferimpoundbtn", 12, FieldType.TRANSFER_BUTTON))),
		                                                        ...
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.LocationInfoSectionHeading", "Location / Timestamp Information"),
		                                                                          ...
		                                                                          new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"), 5, FieldType.DATE_FIELD),
		                                                                                        ...
		                                                                                        new FieldConfig(localization.getLocalizedMessage("ReportWindows.CitationNumField", "citation number"), 2, FieldType.NUMBER_FIELD))), offenderInfoSection, vehicleInfoSection,
		                                                        ...
		                                                        new SectionConfig(localization.getLocalizedMessage("ReportWindows.CitationsHeading", "Citation(s)"), new RowConfig(new FieldConfig("citationview", 6, FieldType.CITATION_TREE_VIEW))));
	...
	public static Map<String, Object> newCitation() {
		...
		Button offenderInfoBtn = (Button) citationReport.get(localization.getLocalizedMessage("ReportWindows.OffenderInfoSectionHeading", "Offender Information") + "_button");
		
		Button vehInfoBtn = (Button) citationReport.get(localization.getLocalizedMessage("ReportWindows.CitationVehicleInfoHeading", "(If Applicable) Offender Vehicle Information") + "_button");
