...
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeAccidentColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeArrestColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeCalloutColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeCitationColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeDeathReportColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeImpoundColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeIncidentColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializePatrolColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeSearchColumns;
import static com.Guess.ReportsPlus.util.Other.InitTableColumns.initializeTrafficStopColumns;
...
public class LogViewController {
	...
	public class ColumnItem {
		...
		public ColumnItem(String name, boolean visible) {
			this.name.set(name);
	...
	public void onDeathReportRowClick(MouseEvent event) {
		if (event.getClickCount() == 1) {
			...
			if (deathReport != null) {
				...
				TextField div = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerDivision", "division"));
				TextField agen = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerAgency", "agency"));
				TextField num = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerNumber", "number"));
				TextField date = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"));
				TextField time = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldTime", "time"));
				ComboBox street = (ComboBox) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldStreet", "street"));
				ComboBox area = (ComboBox) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldArea", "area"));
				TextField county = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldCounty", "county"));
				TextField deathNum = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathNumField", "death num"));
				TextField decedent = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathDecedentField", "decedent name"));
				TextField age = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathAgeDOBField", "age/dob"));
				TextField gender = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathGenderField", "gender"));
				TextField address = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathReportAddressField", "address"));
				TextField description = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.DeathDescField", "description"));
				TextField causeofdeath = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.CauseOfDeathField", "cause of death"));
				TextField modeofdeath = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.ModeOfDeathField", "mode of death"));
				TextField witnesses = (TextField) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldWitnesses", "witnesses"));
				TextArea notes = (TextArea) deathReport1
						.get(localization.getLocalizedMessage("ReportWindows.FieldNotes", "Notes"));
				TextField timeofdeath = (TextField) deathReport1
		...
		if (event.getClickCount() == 1) {
			...
			if (patrolReport != null) {
				...
				TextField rank = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerRank", "rank"));
				TextField div = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerDivision", "division"));
				TextField agen = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerAgency", "agency"));
				TextField num = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerNumber", "number"));
				TextField patrolnum = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.PatrolNumField", "patrolnumber"));
				TextArea notes = (TextArea) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldNotes", "Notes"));
				TextField date = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"));
				TextField starttime = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.StartTimeField", "starttime"));
				TextField stoptime = (TextField) patrolReportMap
						.get(localization.getLocalizedMessage("ReportWindows.StopTimeField", "stoptime"));
				TextField length = (TextField) patrolReportMap
		...
		if (event.getClickCount() == 1) {
			...
			if (trafficStopReport != null) {
				...
				TextField officerrankts = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerRank", "rank"));
				TextField officerdivts = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerDivision", "division"));
				TextField officeragents = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerAgency", "agency"));
				...
				TextField offenderGenderts = (TextField) trafficStopReportMap
				...
				TextField otherInfots = (TextField) trafficStopReportMap
				...
				ComboBox streetts = (ComboBox) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldStreet", "street"));
				TextField countyts = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldCounty", "county"));
				TextField stopnumts = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.StopNumber", "stop number"));
				TextField datets = (TextField) trafficStopReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"));
		...
		if (event.getClickCount() == 1) {
			...
			if (impoundReport != null) {
				...
				TextField officerrank = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerRank", "rank"));
				TextField officerdiv = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerDivision", "division"));
				TextField officeragen = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerAgency", "agency"));
				...
				TextField offenderAge = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOffenderAge", "offender age"));
				TextField offenderGender = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOffenderGender", "offender gender"));
				...
				ComboBox type = (ComboBox) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldType", "type"));
				TextField plateNumber = (TextField) impoundReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldPlateNumber", "plate number"));
	...
	public void onSearchRowClick(MouseEvent event) {
		if (event.getClickCount() == 1) {
			...
			if (searchReport != null) {
				...
				TextField searchedindividual = (TextField) searchReportMap.get(localization
		...
		if (event.getClickCount() == 1) {
			...
			if (arrestReport != null) {
				...
				TextField officerrank = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerRank", "rank"));
				TextField officerdiv = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerDivision", "division"));
				TextField officeragen = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldOfficerAgency", "agency"));
				...
				ComboBox street = (ComboBox) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldStreet", "street"));
				TextField county = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldCounty", "county"));
				TextField arrestnum = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.ArrestNumberField", "arrest number"));
				TextField date = (TextField) arrestReportMap
						.get(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"));
	...
	public void onAccidentReportRowClick(MouseEvent event) {
		if (event.getClickCount() == 1) {
			...
			if (accidentReport != null) {
				...
				TextField weatherConditions = (TextField) accidentReportMap.get(localization
						.getLocalizedMessage("ReportWindows.AccidentWeatherConditionsField", "weather conditions"));
				TextField roadConditions = (TextField) accidentReportMap.get(localization
						.getLocalizedMessage("ReportWindows.AccidentRoadConditionsField", "road conditions"));
				...
				TextField offenderAddress = (TextField) accidentReportMap.get(
						localization.getLocalizedMessage("ReportWindows.FieldOffenderAddress", "offender address"));
				TextField offenderDescription = (TextField) accidentReportMap.get(localization
						.getLocalizedMessage("ReportWindows.FieldOffenderDescription", "offender description"));
	...
	private void loadLocale() {
		reportsTitlePane.setText(localization.getLocalizedMessage("LogBrowser.ReportsButton", "Reports"));
		reportsTitlePane.setText(localization.getLocalizedMessage("LogBrowser.legacyReportsButton", "Legacy Reports"));
		...
		reportsInProgressHeader.setText(
				localization.getLocalizedMessage("LogBrowser.reportsInProgressHeader", "Reports In Progress:"));
		closedReportsHeader
				.setText(localization.getLocalizedMessage("LogBrowser.closedReportsHeader", "Reports Closed:"));
	}
				...
				try {
					...
					if (columnLayoutRecord != null) {
						...
						if (layoutContent != null) {
							...
							Map<String, List<String>> fieldNames = elementMap.getOrDefault("fieldNames",
									new HashMap<>());
							...
							for (String key : fieldNames.keySet()) {
								...
								if (selectedType.equalsIgnoreCase("blank_space")) {
									continue;
								}
				...
				try {
					...
					for (String columnName : visibleColumns) {
						...
						if (columnName.equals("report_status")) {
							col = new TableColumn<>(
									localization.getLocalizedMessage("LogBrowser.ReportStatus", "Status"));
						} else {
						...
						col.setCellFactory(column -> new TableCell<Map<String, Object>, String>() {
							...
							protected void updateItem(String item, boolean empty) {
								...
								if (empty || item == null) {
									...
									String baseStyle = "-fx-background-radius: 7; -fx-padding: 1 10;"
											+ commonTableFontSize;
									if (item.trim().equalsIgnoreCase("In Progress")) {
										label.setStyle(baseStyle
												+ " -fx-background-color: rgba(211,94,243,0.78);-fx-text-fill: white;");
									} else if (item.trim().equalsIgnoreCase("Reopened")) {
										label.setStyle(baseStyle
												+ " -fx-background-color: rgba(121,175,255,0.78);-fx-text-fill: white;");
									} else if (item.trim().equalsIgnoreCase("Pending")) {
										label.setStyle(baseStyle
												+ " -fx-background-color: rgba(199,204,87,0.78);-fx-text-fill: white;");
									} else if (item.trim().equalsIgnoreCase("Cancelled")) {
										label.setStyle(baseStyle
												+ " -fx-background-color: rgba(244,96,75,0.78);-fx-text-fill: white;");
									} else {
										label.setStyle(baseStyle);
									}
									setGraphic(label);
					...
					DynamicDB databaseData = new DynamicDB(dataFolderPath + reportTitle, "data",
							foundPrimaryKeyDataTable, dataScheme);
					if (databaseData.initDB()) {
						...
						try {
									...
									if (mouseEvent.getClickCount() == 1 && !row.isEmpty()) {
										...
										for (String field : fieldNames.keySet()) {
											...
											if ("NUMBER_FIELD".equalsIgnoreCase(selectedType)) {
												...
												TextField number_field = (TextField) customReport.getReportMap()
														.get(field);
										...
										delBtn.setOnAction(_ -> {
											...
											try {
												if (ConfigReader.configRead("soundSettings", "playDeleteReport")
							...
							try {
								...
								logError("LogViewer; Error closing Database: [" + databaseData.getTableName() + "]",
										e2);
							}
						}
					} else {
					...
					TitledPane titledPane = new TitledPane(
							localization.getLocalizedMessage("LogBrowser.TableSettings", "Table Settings"),
							tableSettingsHbox);
					...
					for (String column : allColumns2) {
						String[] parts = column.split("=");
						if (parts.length == 2) {
							columnItems.add(new ColumnItem(parts[0], Boolean.parseBoolean(parts[1])));
						}
					}
					...
					columnManagerList.setCellFactory(param -> {
						...
						cell.setOnDragDetected(event -> {
							...
							content.putString(String.valueOf(columnItems.indexOf(cell.getItem())));
					...
					moveUpBtn.setOnAction(e -> {
						...
						if (selectedIndex > 0) {
							Collections.swap(columnItems, selectedIndex, selectedIndex - 1);
					...
					applyButton.setOnAction(e -> {
						...
						for (int i = 0; i < columnItems.size(); i++) {
							...
							newLayoutBuilder.append(item.getName()).append("=").append(item.isVisible());
							if (i < columnItems.size() - 1) {
								newLayoutBuilder.append(",");
							}
						}
						...
						try {
							if (dbLayout.initDB()) {
								...
								record.put("key", "3");
								record.put("columnLayoutData", newColumnLayout);
							...
							try {
								...
								logError("Error closing layout DB", ex);
							}
						}
