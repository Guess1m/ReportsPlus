...
public class updatesController {
	...
	public void initialize() {
		...
		currentverlabel
				.setText(localization.getLocalizedMessage("UpdatesWindow.CurrentVersionLabel", "Current Version:"));
		changeloglabel.setText(localization.getLocalizedMessage("UpdatesWindow.ChangelogLabel", "Changelog"));
		mostrecentlabel
				.setText(localization.getLocalizedMessage("UpdatesWindow.MostRecentLabel", "Most Recent Version:"));
		verinfolabel.setText(localization.getLocalizedMessage("UpdatesWindow.VersionInfoLabel", "Version Information"));
		localeChangesBtn.setText(version + " "
				+ localization.getLocalizedMessage("UpdatesWindow.LocaleChangesButton", "Locale Changes"));
	}
	...
	public void LaunchUpdater(ActionEvent actionEvent) {
		if (updateAvailable) {
			WindowManager.createCustomWindow(mainDesktopControllerObj.getDesktopContainer(),
					"Windows/Misc/autoUpdater-tool.fxml", "AutoUpdate Utility", true, 1, true, true,
	...
	private void checkUpdates() {
		...
		if (!version.equals(gitVersion)) {
			...
			showNotificationError("Update Available",
					localization.getLocalizedMessage("Desktop.NewVersionAvailable", "New Version Available!") + " ["
							+ gitVersion + "] You can try autoupdating!");
