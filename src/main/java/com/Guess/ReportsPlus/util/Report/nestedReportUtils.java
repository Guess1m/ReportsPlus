...
public class nestedReportUtils {
    public enum FieldType {
        TEXT_FIELD("TEXT_FIELD"), NUMBER_FIELD("TEXT_FIELD"), DATE_FIELD("TEXT_FIELD"), TIME_FIELD("TEXT_FIELD"), OFFICER_NAME("TEXT_FIELD"), OFFICER_RANK("TEXT_FIELD"), OFFICER_DIVISION("TEXT_FIELD"), OFFICER_AGENCY("TEXT_FIELD"), OFFICER_NUMBER("TEXT_FIELD"), OFFICER_CALLSIGN("TEXT_FIELD"), TEXT_AREA("TEXT_AREA"), COMBO_BOX_STREET("COMBO_BOX"), COMBO_BOX_AREA("COMBO_BOX"), COUNTY_FIELD("TEXT_FIELD"), COMBO_BOX_COLOR("COMBO_BOX"), COMBO_BOX_TYPE("COMBO_BOX"), COMBO_BOX_SEARCH_TYPE("COMBO_BOX"), COMBO_BOX_SEARCH_METHOD("COMBO_BOX"), CITATION_TREE_VIEW("TREE_VIEW"), CHARGES_TREE_VIEW("TREE_VIEW"), TRANSFER_BUTTON("BUTTON"), CUSTOM_DROPDOWN("COMBO_BOX");
