...
import static com.Guess.ReportsPlus.Desktop.mainDesktopController.userManager;
...
public class UserManagerController {
	...
	public void initialize() throws IOException {
		...
		lbl1.setText(localization.getLocalizedMessage("UserManager.MainHeader", "Edit Officer Data:"));
		nameField.setPromptText(localization.getLocalizedMessage("UserManager.NameFieldPrompt", "Name"));
		numberField.setPromptText(localization.getLocalizedMessage("UserManager.NumberFieldPrompt", "Number"));
	}
