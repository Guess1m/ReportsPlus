...
public class InitTableColumns {
    ...
    public static void initializeDeathReportColumns(TableView tableview) {
        ...
        ObservableList<TableColumn<DeathReport, ?>> deathReportColumns = FXCollections.observableArrayList(notesColumn, divisionColumn, agencyColumn, numberColumn, rankColumn, nameColumn, streetColumn, countyColumn, areaColumn, dateColumn, timeColumn, deathReportNumberColumn, decedentColumn, ageColumn, genderColumn, descriptionColumn, addressColumn, witnessesColumn, causeOfDeathColumn, modeOfDeathColumn, timeofDeathColumn, dateOfDeathColumn);
    ...
    public static void initializeCalloutColumns(TableView tableview) {
        ...
        ObservableList<TableColumn<CalloutReport, ?>> columns = FXCollections.observableArrayList(calloutNumberColumn, dateColumn, timeColumn, notesTextAreaColumn, responseGradeColumn, responseTypeColumn, divisionColumn, agencyColumn, numberColumn, rankColumn, nameColumn, addressColumn, countyColumn, areaColumn);
    ...
    public static void initializeAccidentColumns(TableView tableview) {
        ...
        ObservableList<TableColumn<AccidentReport, ?>> columns = FXCollections.observableArrayList(accidentNumberColumn, dateColumn, timeColumn, streetColumn, areaColumn, countyColumn, weatherConditionsColumn, roadConditionsColumn, otherVehiclesInvolvedColumn, plateNumberColumn, colorColumn, typeColumn, modelColumn, ownerNameColumn, ownerAgeColumn, ownerGenderColumn, ownerAddressColumn, ownerDescriptionColumn, witnessesColumn, injuriesReportedColumn, damageDetailsColumn, officerRankColumn, officerNameColumn, officerNumberColumn, officerAgencyColumn, officerDivisionColumn, commentsColumn);
        tableview.getColumns().addAll(columns);
