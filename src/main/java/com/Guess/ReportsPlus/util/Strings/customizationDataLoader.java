...
public class customizationDataLoader {
    ...
    private static final List<String> DEFAULT_STREETS = Arrays.asList("N/A", "Abattoir Avenue", "Abe Milton Parkway", "Ace Jones Drive", "Adam's Apple Boulevard", "Aguja Street", "Alta Place", "Alta Street", "Amarillo Vista", "Amarillo Way", "Americano Way", "Atlee Street", "Autopia Parkway", "Banham Canyon Drive", "Barbareno Road", "Bay City Avenue", "Bay City Incline", "Baytree Canyon Road", "Boulevard Del Perro", "Bridge Street", "Brouge Avenue", "Buccaneer Way", "Buen Vino Road", "Caesars Place", "Calais Avenue", "Calafia Road", "Capital Boulevard", "Carcer Way", "Carson Avenue", "Cassidy Trail", "Cat-Claw Avenue", "Chianski Passage", "Cholla Road", "Cholla Springs Avenue", "Chum Street", "Chupacabra Street", "Clinton Avenue", "Cockingend Drive", "Conquistador Street", "Cortes Street", "Cougar Avenue", "Covenant Avenue", "Cox Way", "Crusade Road", "Davis Avenue", "Decker Street", "Del Perro Freeway", "Didion Drive", "Dorset Drive", "Dorset Place", "Dry Dock Street", "Duluoz Avenue", "Dunstable Drive", "Dunstable Lane", "Dutch London Street", "East Galileo Avenue", "East Joshua Road", "East Mirror Drive", "Eastbourne Way", "Eclipse Boulevard", "Edwood Way", "El Burro Boulevard", "El Rancho Boulevard", "Elgin Avenue", "Elysian Fields Freeway", "Equality Way", "Exceptionalists Way", "Fantastic Place", "Fenwell Place", "Fort Zancudo Approach Road", "Forum Drive", "Fudge Lane", "Galileo Road", "Gentry Lane", "Ginger Street", "Glory Way", "Goma Street", "Great Ocean Highway", "Grapeseed Avenue", "Grapeseed Main Street", "Greenwich Parkway", "Greenwich Place", "Greenwich Way", "Grove Street", "Hanger Way", "Hangman Avenue", "Hardy Way", "Hawick Avenue", "Heritage Way", "Hillcrest Avenue", "Hillcrest Ridge Access Road", "Imagination Court", "Industry Passage", "Ineseno Road", "Integrity Way", "Interstate 1", "Interstate 2", "Interstate 4", "Interstate 5", "Invention Court", "Innocence Boulevard", "Jamestown Street", "Joad Lane", "Joshua Road", "Kimble Hill Drive", "Kortz Drive", "Labor Place", "Laguna Place", "Lake Vinewood Drive", "La Puerta Freeway", "Las Lagunas Boulevard", "Lesbos Lane", "Liberty Street", "Lindsay Circus", "Little Bighorn Avenue", "Lolita Avenue", "Los Santos Freeway", "Low Power Street", "Macdonald Street", "Mad Wayne Thunder Drive", "Magellan Avenue", "Marathon Avenue", "Marina Drive", "Marlowe Drive", "Melanoma Street", "Meringue Lane", "Meteor Street", "Milton Road", "Mirror Park Boulevard", "Mirror Place", "Morningwood Boulevard", "Mount Haan Drive", "Mount Haan Road", "Mount Vinewood Drive", "Mountain View Drive", "Movie Star Way", "Mutiny Road", "New Empire Way", "Nikola Avenue", "Nikola Place", "Niland Avenue", "North Archer Avenue", "North Calafia Way", "North Conker Avenue", "North Rockford Drive", "North Sheldon Avenue", "Nowhere Road", "O'Neil Way", "Occupation Avenue", "Olympic Freeway", "Orchardville Avenue", "Paleto Boulevard", "Palomino Avenue", "Palomino Freeway", "Panorama Drive", "Peaceful Street", "Perth Street", "Picture Perfect Drive", "Plaice Place", "Playa Vista", "Popular Street", "Portola Drive", "Power Street", "Procopio Drive", "Procopio Promenade", "Prosperity Street", "Prosperity Street Promenade", "Pyrite Avenue", "Raton Pass", "Red Desert Avenue", "Richman Street", "Rockford Drive", "Route 1", "Route 11", "Route 13", "Route 14", "Route 15", "Route 16", "Route 17", "Route 18", "Route 19", "Route 20", "Route 22", "Route 23", "Route 68", "Route 68 Approach", "Rub Street", "Sam Austin Drive", "San Andreas Avenue", "San Vitus Boulevard", "Sandcastle Way", "Seaview Road", "Senora Freeway", "Senora Road", "Senora Way", "Shank Street", "Signal Street", "Sinner Street", "Sinners Passage", "Smoke Tree Road", "South Arsenal Street", "South Boulevard Del Perro", "South Mo Milton Drive", "South Rockford Drive", "South Shambles Street", "Spanish Avenue", "Steele Way", "Strangeways Drive", "Strawberry Avenue", "Supply Street", "Sustancia Road", "Swiss Street", "Tackle Street", "Tangerine Street", "Tongva Drive", "Tower Way", "Tug Street", "Union Road", "Utopia Gardens", "Vespucci Boulevard", "Vinewood Boulevard", "Vinewood Park Drive", "Vitus Street", "Voodoo Place", "West Eclipse Boulevard", "West Galileo Avenue", "West Mirror Drive", "Whispymound Drive", "Wild Oats Drive", "York Street", "Zancudo Avenue", "Zancudo Barranca", "Zancudo Road", "Zancudo Trail");
    private static final List<String> DEFAULT_AGENCIES = Arrays.asList("Los Santos Police Department [LSPD]", "Los Santos Sheriff's Department [LSSD]", "Blaine County Sheriff's Office [BCSO]", "San Andreas Highway Patrol [SAHP]", "Federal Investigation Bureau [FIB]", "International Affairs Agency [IAA]", "San Andreas State Parks [SASP]", "Drug Obeservation Agency [DOA]", "Burea of Alcohol, Tobacco, Firearms and Explosives [ATF]", "Patriotism and Immigration Authority [PIA]", "United States Marshal Service [USMS]");
    private static final List<String> DEFAULT_RANKS = Arrays.asList("POLICE DEPARTMENT", "Police Officer", "Senior Police Officer", "Sergeant", "Lieutenant", "Captain", "Chief of Police", "", "SHERIFF'S OFFICE ", "Deputy", "Senior Deputy", "Sergeant", "Lieutenant", "Captain", "Sheriff", "", "HIGHWAY PATROL", "State Trooper", "Senior State Trooper", "Sergeant", "Lieutenant", "Captain", "", "FEDERAL AGENCIES", "Special Agent", "Supervisory Special Agent", "Border Patrol Agent", "Supervisory Border Patrol Agent", "Deputy U.S. Marshal", "Supervisory Deputy U.S. Marshal", "", "PARKS SERVICES", "Ranger", "Senior Park Ranger", "Ranger Corporal", "Ranger Sergeant", "Ranger Lieutenant", "Game Warden");
    private static final List<String> DEFAULT_DIVISIONS = Arrays.asList("PATROL OPERATIONS", "Central Patrol Division", "Northern Patrol Division", "Southern Patrol Division", "Eastern Patrol Division", "Western Patrol Division", "Harbor/Port Patrol Division", "", "CRIMINAL INVESTIGATIONS", "Major Crimes Division", "Homicide & Violent Crimes Section", "Narcotics & Gang Enforcement Section", "Special Victims Unit", "Forensic Science Section", "Financial Crimes Section", "", "SPECIAL OPERATIONS", "SWAT/Tactical Division", "K-9 Unit", "Air Support Division", "Marine Enforcement Division", "Mounted Patrol Unit", "Traffic Enforcement Division", "", "ADMINISTRATIVE SERVICES", "Professional Standards Division", "Training & Development Section", "Public Affairs Unit", "Records Management Bureau", "", "TECHNICAL SERVICES", "Crime Analysis Division", "Communications Unit", "Fleet Management Section", "", "CUSTODY OPERATIONS", "Detention Services Division", "Inmate Management Bureau", "Correctional Facilities Unit", "", "REGIONAL COMMANDS", "Metro Region Command", "Northern Region Command", "Southern Region Command", "Border Security Command", "", "INTERAGENCY OPERATIONS", "Joint Terrorism Task Force", "Multi-Agency Gang Unit", "Emergency Management Section");
    private static final List<String> DEFAULT_AREALIST = Arrays.asList("N/A", "Alamo Sea", "Alta", "Backlot City", "Banham Canyon", "Banning", "Baytree Canyon", "Bolingbroke Penitentiary", "Burton", "Cape Catfish", "Cayo Perico", "Chamberlain Hills", "Chiliad Mountain State Wilderness", "Chumash", "Cypress Flats", "Davis", "Davis Quartz", "Del Perro", "Del Perro Beach", "Dignity Village", "Downtown Los Santos", "Downtown Vinewood", "East Los Santos", "East Vinewood", "El Burro Heights", "Elysian Island", "Fort Zancudo", "Galilee", "Galileo Park", "Grand Senora Desert", "Grapeseed", "Great Chaparral", "Great Ocean Highway", "GWC and Golfing Society", "Harmony", "Heart Attacks Beach", "La Mesa", "La Puerta", "Lago Zancudo", "Lake Vinewood", "Lake Vinewood Estates", "Land Act Reservoir", "Legion Square", "Little Seoul", "Los Santos International Airport", "Ludendorff", "Marlowe Vineyards", "Mirror Park", "Mirror Park Railyard", "Mission Row", "Morningwood", "Mount Chiliad", "Mount Gordo", "Mount Josiah", "Murrieta Heights", "North Chumash", "North Point", "North Yankton (Ludendorff)", "Pacific Bluffs", "Paleto Bay", "Paleto Cove", "Palomino Highlands", "Pillbox Hill", "Port of Los Santos", "Procopio Beach", "Puerto Del Sol", "Rancho", "Redwood Lights Track", "Richman", "Richman Glen", "RON Alternates Wind Farm", "Rockford Hills", "Sandy Shores", "San Chianski Mountain Range", "Stab City", "Strawberry", "Tataviam Mountains", "Terminal", "Textile City", "Tongva Hills", "Tongva Valley", "Vespucci Beach", "Vespucci Canals", "Vinewood Hills", "Vinewood Racetrack", "West Vinewood");
    private static final List<String> DEFAULT_SEARCH_METHODS = Arrays.asList("N/A", "Search Warrant", "Probable Cause", "Consent Search", "Exigent Circumstances", "Plain View Doctrine", "Incident to Arrest", "Stop and Frisk", "Terry Frisk", "K-9 Search", "Electronic Surveillance", "Field Sobriety Test");
    ...
    private static final List<String> DEFAULT_VEHICLE_TYPES = Arrays.asList("N/A", "Car", "Truck", "Motorcycle", "Bus", "Van", "SUV", "Pickup Truck", "Box Truck", "Tractor Trailer", "Flatbed", "Bicycle", "Tractor", "RV", "Taxi", "Ambulance", "Fire Truck", "Police Car", "Limousine", "Train", "Boat", "Airplane", "Helicopter", "Scooter", "Jet Ski", "Golf Cart", "Go-Kart");
