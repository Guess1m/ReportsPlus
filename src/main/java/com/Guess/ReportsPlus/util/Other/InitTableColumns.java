...
public class InitTableColumns {
			...
			protected void updateItem(String item, boolean empty) {
				...
				if (empty || item == null) {
					...
					String baseStyle = "-fx-background-radius: 7; -fx-padding: 1 10;" + commonTableFontSize
							+ "-fx-font-family: \"Inter 28pt Medium\";";
	...
	public static void initializeImpoundColumns(TableView tableview) {
		...
		ObservableList<TableColumn<ImpoundReport, ?>> impoundColumns = FXCollections
				.observableArrayList(impoundNumberColumn, statusColumn, impoundPlateNumberColumn, ownerNameColumn);
	...
	public static void initializeArrestColumns(TableView tableview) {
		...
		ObservableList<TableColumn<ArrestReport, ?>> arrestColumns = FXCollections
				.observableArrayList(arrestNumberColumn, statusColumn, arrestDateColumn, arresteeNameColumn);
	...
	public static void initializeCalloutColumns(TableView tableview) {
		...
		ObservableList<TableColumn<CalloutReport, ?>> columns = FXCollections.observableArrayList(calloutNumberColumn,
				statusColumn, responseGradeColumn, responseTypeColumn, areaColumn);
	...
	public static void initializeAccidentColumns(TableView tableview) {
		...
		ObservableList<TableColumn<AccidentReport, ?>> columns = FXCollections.observableArrayList(accidentNumberColumn,
				statusColumn, plateNumberColumn, ownerNameColumn, streetColumn, roadConditionsColumn);
		tableview.getColumns().addAll(columns);
