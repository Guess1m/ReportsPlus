	...
	private void keybindEvent(KeyEvent event) {
		...
		try {
			...
			if (code == inputLockKey) {
				...
				CustomWindow terminalApp = WindowManager.createCustomWindow(desktopContainer, "Windows/Misc/terminal.fxml", "Terminal", true, 1, true, true, taskBarApps, new Image(Launcher.class.getResourceAsStream("/com/Guess/ReportsPlus/imgs/icons/Logo.png")));
