...
public class URLStrings {
	...
	public static final String trafficCitationLogURL = controllerUtils.getDataLogsFolderPath()
			+ "trafficCitationLogs.xml";
	...
	public static final String currentLocationFileURL = controllerUtils.getServerDataFolderPath()
			+ "ServerLocation.data";
	public static final String serverGameDataFileURL = controllerUtils.getServerDataFolderPath()
			+ "ServerGameData.data";
	public static final String serverLookupURL = controllerUtils.getServerDataFolderPath() + "ServerLookup.data";
	public static final String pedImageFolderURL = controllerUtils.getJarPath() + File.separator + "images"
			+ File.separator + "peds";
	public static final String vehImageFolderURL = controllerUtils.getJarPath() + File.separator + "images"
