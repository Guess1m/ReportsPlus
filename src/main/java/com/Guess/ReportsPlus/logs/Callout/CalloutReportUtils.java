...
public class CalloutReportUtils {
	...
	public static Map<String, Object> calloutLayout() {
		Map<String, Object> calloutReport = createReportWindow(localization.getLocalizedMessage("ReportWindows.CalloutReportTitle", "Callout Report"), null, new SectionConfig(localization.getLocalizedMessage("ReportWindows.OfficerInfoSectionHeading", "Officer Information"), new RowConfig(
		                                                       ...
		                                                       new SectionConfig("Location Information", new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldStreet", "street"), 5, FieldType.COMBO_BOX_STREET),
		                                                       ...
		                                                       new SectionConfig(localization.getLocalizedMessage("CalloutPopup.MainHeading", "Callout Information"), new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldDate", "date"), 6, FieldType.DATE_FIELD),
		                                                                                                                                                                            new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldTime", "time"), 6, FieldType.TIME_FIELD)),
		                                                                         new RowConfig(new FieldConfig(localization.getLocalizedMessage("ReportWindows.FieldType", "type"), 4, FieldType.TEXT_FIELD),
		                                                                                       new FieldConfig(localization.getLocalizedMessage("ReportWindows.CalloutCodeField", "code"), 4, FieldType.TEXT_FIELD),
		                                                                                       new FieldConfig(localization.getLocalizedMessage("ReportWindows.CalloutNumberField", "callout num"), 4, FieldType.NUMBER_FIELD))),
